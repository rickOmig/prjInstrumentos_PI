 ...
 * @author alves
 */
public class TelaVendaProdutosDeprecated extends javax.swing.JDialog {

    /**
     * Creates new form TelaVendaProdutos
     */
    public TelaVendaProdutosDeprecated() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        selecao_produto = new javax.swing.JComboBox<>();
        ...
        selecao_produto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5", "6", " " }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(selecao_produto, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(124, 124, 124)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(lblProdutos, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(selecao_produto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        DefaultTableModel carrinho = (DefaultTableModel) tableVenda.getModel();
        Object[] dados = {selecao_produto.getSelectedItem(),
            spnQuantidade.getValue(),
            jtxtCampo_CPF.getText().replace(".", "").replace("-", ""),
            campo_data.getText()};

        carrinho.addRow(dados);

        //int codigo = Integer.parseInt(modelo.getValueAt(linhaSelecionada, 0).toString());
        //int[] selectedRows = tableVenda.getSelectedRows();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVendaProdutosDeprecated.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVendaProdutosDeprecated().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> selecao_produto;
